        ...
        {PACKAGES.map((pkg) => {
          ...
          return (
            <div
              ...
              className={`relative cursor-pointer rounded-[2rem] p-6 transition-all duration-300 border-2 flex flex-col justify-between ${isSelected
            ...
            >
              ...
              <div className="w-full">
                ...
                <div className="flex items-baseline gap-1 mb-1">
                  <div className={`font-black text-4xl tracking-tighter leading-none ${isSelected ? "text-[#0d1655]" : "text-white"}`}>
                    {(() => {
                ...
                <div className={`h-0.5 w-full my-4 ${isSelected ? "bg-orange-100" : "bg-white/10"}`}></div>
              ...
              <div className="w-full mt-auto">
                <div className={`border-t pt-4 mb-4 ${isSelected ? "border-slate-100" : "border-white/10"}`}>
                  <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Investasi Bulanan</div>
                  <div className="flex items-baseline gap-1">
                    <div className="text-[#F47920] font-black text-2xl tracking-tight">Rp {pkg.price}</div>
                    <div className={`text-[10px] uppercase font-black ${isSelected ? "text-slate-400" : "text-white/40"}`}>/ bln</div>
                  </div>
                </div>

                <div className={`w-full py-3.5 rounded-2xl text-xs font-black uppercase tracking-widest text-center transition-all ${isSelected
